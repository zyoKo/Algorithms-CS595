...
void test2() {
	...
	readPoints("C:\\Projects\\Repos\\Algorithms-CS595\\ConvexHull\\src\\points1", points);
	std::set<int> hull = hullBruteForce(points);
...
void test3() {
	std::vector<Point> points;
	readPoints("C:\\Projects\\Repos\\Algorithms-CS595\\ConvexHull\\src\\points2", points);
	std::set<int> hull = hullBruteForce(points);
...
void test4() {
	std::vector<Point> points;
	readPoints("C:\\Projects\\Repos\\Algorithms-CS595\\ConvexHull\\src\\points3", points);
	std::set<int> hull = hullBruteForce(points);
...
void test5() {
	std::vector<Point> points;
	readPoints("C:\\Projects\\Repos\\Algorithms-CS595\\ConvexHull\\src\\points4", points);
	std::set<int> hull = hullBruteForce(points);
...
void test6() {
	std::vector<Point> points;
	readPoints("C:\\Projects\\Repos\\Algorithms-CS595\\ConvexHull\\src\\points5", points);
	std::set<int> hull = hullBruteForce(points);
...
void test7() {
	std::vector<Point> points;
	readPoints("C:\\Projects\\Repos\\Algorithms-CS595\\ConvexHull\\src\\points6", points);
	std::set<int> hull = hullBruteForce(points);
...
void ExecuteFunctions(const std::vector<std::function<void()>>& functionsToExecute)
{
	for (auto i = 0; i < functionsToExecute.size(); ++i)
	{
		std::cout << "Executing Test: " << i << "\n";
